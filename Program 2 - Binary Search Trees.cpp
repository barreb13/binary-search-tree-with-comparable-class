...
int main() {
	...
	//cout << "T3 == T2?              " << (T3 == T2 ? "equal" : "not equal") << endl;
	//cout << "T3 != T2?              " << (T3 != T2 ? "not equal" : "equal") << endl;
	//T2.makeEmpty();
	...
	//cout << "\n\nT Frequency Table: " << endl << T << endl;
	//for (int i = 28; i > 0; i--) {
	//	T.remove(in1);
	//}
	//cout << "\n\nAfter Removing all s in tree...T Frequency Table: " << endl << T << endl;
	...
	//T.remove(in2);
	//T.remove(in2);
	//cout << "\n\nAfter Removing all Ts in tree...T Frequency Table: " << endl << T << endl;
